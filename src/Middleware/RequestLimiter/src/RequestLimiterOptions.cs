...
namespace Microsoft.AspNetCore.RequestLimiter
{
    public class RequestLimiterOptions
    {
        ...
        {
            ResolveDefaultRequestLimit = _ => new AggregatedResourceLimiterOfHttpContextWrapper(limiter);
        }
        ...
        public RequestDelegate OnRejected { get; set; } = context => Task.CompletedTask;
    }
}
